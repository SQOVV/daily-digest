...
? 653  |  ?? TypeScript  |  _GitHub Search_  
...
? 547  |  ?? JavaScript  |  _GitHub Search_  `agent-skills` `claude` `claude-code` `claude-design` `cursor`
...
? 516  |  ?? Go  |  _GitHub Search_  `ai` `ai-agent` `dev-environment` `docker` `isolation`

5. ### [nevertoday/zhongguo-traditional-colors](https://github.com/nevertoday/zhongguo-traditional-colors)

中华传统色演示、色卡浏览与颜色知识科普开源项目

? 492  |  ?? JavaScript  |  _GitHub Search_  
...
? 485  |  ?? JavaScript  |  _GitHub Search_  `bilibili` `chrome-extension` `launchd` `macos` `manifest-v3`

7. ### [amElnagdy/guard-skills](https://github.com/amElnagdy/guard-skills)

Guard skills for coding agents, quality gates that catch AI-generated failure modes in code, tests, and docs

? 474  |  ?? N/A  |  _GitHub Search_  `agent-skills` `ai` `claude` `claude-code` `code-review`
...
? 452  |  ?? TypeScript  |  _GitHub Search_  `drive` `gateway` `google` `storage`
...
- [Job: Head of Stonehenge](https://www.english-heritage.org.uk/about/our-people/careers-with-us/job-search/default-job-page/?jobRef=16449)  ?97  by _mooreds_
- [Apple reveals new AI architecture built around Google Gemini models](https://www.macrumors.com/2026/06/08/apple-reveals-new-ai-architecture/)  ?451  by _unclefuzzy_
- [Old'aVista – The most powerful guide to the old Internet](https://oldavista.com/)  ?34  by _abnercoimbre_
- [Siri AI](https://www.apple.com/apple-intelligence/)  ?490  by _0xedb_
- [xAI is looking more like a datacentre REIT than a frontier lab](https://martinalderson.com/posts/xais-new-rental-business/)  ?482  by _martinald_
