...
? 26785  |  ?? JavaScript  |  _GitHub Search_  `agent-skills` `ai-agents` `claude` `claude-code` `claude-code-plugin`

2. ### [omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent)

A meta-harness for all your AI agents.  Omnigent provides a common layer over Claude Code, Codex, Pi, and the agents you...

? 2978  |  ?? Python  |  _GitHub Search_  `agents` `ai` `ai-agents` `developer-tools` `llm`

3. ### [tamnd/kage](https://github.com/tamnd/kage)

Shadow any website for offline viewing, with the JavaScript stripped out

? 1789  |  ?? Go  |  _GitHub Search_  
...
? 735  |  ?? N/A  |  _GitHub Search_  

8. ### [joeseesun/qiaomu-goal-meta-skill](https://github.com/joeseesun/qiaomu-goal-meta-skill)

Turn vague or complex Codex tasks into strong `/goal` commands with outcome, verification, constraints, boundaries, iter...

? 637  |  ?? Python  |  _GitHub Search_  

9. ### [nolangz/pixel2motion](https://github.com/nolangz/pixel2motion)

AI logo animation skill: turn raster logos into smooth SVG animation, animated HTML demos, GIF/video previews, and motio...

? 627  |  ?? Python  |  _GitHub Search_  `ai-design-tools` `animated-logo` `brand-motion` `claude-skill` `codex-skill`
...
- [GrapheneOS has been ported to Android 17](https://discuss.grapheneos.org/d/36469-grapheneos-has-been-ported-to-android-17-and-official-releases-are-coming-soon)  ?582  by _Cider9986_
- [Running local models is good now](https://vickiboykis.com/2026/06/15/running-local-models-is-good-now/)  ?1174  by _jfb_
- [Humiliating IIS servers for fun and jail time](https://mll.sh/humiliating-iis-servers-for-fun-and-jail-time/)  ?176  by _denysvitali_
- [Wolfram Language and Mathematica Version 15, AI Assistant, Symbolic Music, More](https://writings.stephenwolfram.com/2026/06/launching-version-15-of-wolfram-language-mathematica-built-in-useful-ai-lots-of-new-core-functionality/)  ?128  by _alok-g_
- [TIL: You can make HTTP requests without curl using Bash /dev/TCP](https://mareksuppa.com/til/bash-dev-tcp-http-without-curl/)  ?354  by _mrshu_
