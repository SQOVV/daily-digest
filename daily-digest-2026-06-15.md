...
? 9322  |  ?? JavaScript  |  _GitHub Search_  `agent-skills` `ai-agents` `claude` `claude-code` `claude-code-plugin`

2. ### [XiaomiMiMo/MiMo-Code](https://github.com/XiaomiMiMo/MiMo-Code)

(no description)

? 8625  |  ?? TypeScript  |  _GitHub Search_  

3. ### [shadcn/improve](https://github.com/shadcn/improve)

Use your most capable model to audit your codebase and write plans for cheaper models to execute.

? 4490  |  ?? N/A  |  _GitHub Search_  
...
? 930  |  ?? Shell  |  _GitHub Search_  

8. ### [tamnd/kage](https://github.com/tamnd/kage)

Shadow any website for offline viewing, with the JavaScript stripped out

? 874  |  ?? Go  |  _GitHub Search_  
...
- [Your ePub Is fine](https://andreklein.net/your-epub-is-fine-kobo-disagrees-blame-adobe/)  ?414  by _sohkamyung_
- [Even more batteries included with Emacs](https://karthinks.com/software/even-more-batteries-included-with-emacs/)  ?105  by _signa11_
- [Show HN: Kage – Shadow any website to a single binary for offline viewing](https://github.com/tamnd/kage)  ?494  by _tamnd_
- [Bitsy](https://bitsy.org/)  ?124  by _tosh_
- [Prove you're human by winning a claw machine](https://feralui.vercel.app/#/captcha)  ?44  by _speckx_
