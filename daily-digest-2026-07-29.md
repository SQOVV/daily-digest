...
? 3586  |  ?? N/A  |  _GitHub Search_  

2. ### [slvDev/esp32-ai](https://github.com/slvDev/esp32-ai)

(no description)

? 2103  |  ?? Python  |  _GitHub Search_  
...
? 806  |  ?? Python  |  _GitHub Search_  

8. ### [fuadmefleh/Shared-Claude-Chats](https://github.com/fuadmefleh/Shared-Claude-Chats)

An archive of public Claude and Grok conversations, exported from their share links as plain markdown, plus the two scri...

? 722  |  ?? Python  |  _GitHub Search_  

9. ### [digimata/quill](https://github.com/digimata/quill)

Ultraminimalist macOS recording + transcription.

? 612  |  ?? Swift  |  _GitHub Search_  

10. ### [0xwilliamortiz/openclaude-improved](https://github.com/0xwilliamortiz/openclaude-improved)

runs anywhere. uses anything

? 584  |  ?? TypeScript  |  _GitHub Search_  `agentic-ai` `ai` `ai-agent` `ai-coding` `ai-coding-agent`
...
- [Codex Security](https://github.com/openai/codex-security)  ?397  by _bakigul_
- [LearnVector – Andrew Ng's AI company building one‑to‑one learning experiences](https://learnvector.ai/)  ?74  by _ajhai_
- [Show HN: I was tired of opening 2 tabs for every HN link, so I made a userscript](https://github.com/twalichiewicz/HNewhere)  ?185  by _twalichiewicz_
- [Half-Life ported to Mac OS 9](https://mac-classic.com/news/half-life-ported-to-mac-os-9/)  ?185  by _freediver_
- [Substack writers, you need a website](https://elizabethtai.com/2026/06/10/substack-writers-you-need-a-website/)  ?455  by _speckx_
